...
4. **Register in `ValidatorRegistryBuilder`** -- Add the validator factory to the `DEFAULTS` array inside `ValidatorRegistryBuilder::with_defaults()` in `crates/agnix-core/src/lib.rs`.
