...
└── zed/            # Zed extension
knowledge-base/     # 145 rules, 75+ sources, rules.json
...
- `rules/` - Validators implementing Validator trait (18 validators)
...
145 rules defined in `knowledge-base/rules.json` (source of truth)
