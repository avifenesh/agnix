...
└── zed/            # Zed extension
knowledge-base/     # 176 rules, 75+ sources, rules.json
...
- `rules/` - Validators implementing Validator trait (22 validators)
...
176 rules defined in `knowledge-base/rules.json` (source of truth)
...
- 176 validation rules across 22 validators
