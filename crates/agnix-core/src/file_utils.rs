...
//!
//! Provides hardened file reading with symlink rejection and size limits
//! to prevent security issues and resource exhaustion.
...
/// 2. Enforces a maximum file size limit
/// 3. Only reads regular files
///
/// # Errors
///
