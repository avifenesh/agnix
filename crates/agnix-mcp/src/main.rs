...
/// MCP configs, and more against 129 rules.
#[derive(Debug, Clone)]
...
impl AgnixServer {
    ...
    #[tool(
        description = "List all 129 validation rules available in agnix. Returns rule IDs and names organized by category (AS-* Agent Skills, CC-* Claude Code, MCP-* Model Context Protocol, COP-* Copilot, CUR-* Cursor, etc.)."
    )]
        ...
        ServerInfo {
            ...
            instructions: Some(
                "Agnix - AI agent configuration linter.\n\n\
                 ...
                 Cursor rules, and more against 129 rules.\n\n\
                 Tools:\n\
