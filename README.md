...
**Integration**: LSP server, VS Code extension, Neovim plugin, Zed extension, GitHub Action, auto-fix (`--fix`)
...
- Live site (GitHub Pages): <https://avifenesh.github.io/agnix/>
- Canonical long-form docs: `README.md`, `SPEC.md`, and `knowledge-base/`
- Website content: `website/docs/` (with generated rules pages from `knowledge-base/rules.json`)
...
**Zed extension** with automatic LSP binary download and MDC file type support. See [Zed extension](editors/zed/README.md) for details.

See [Editor Setup](docs/EDITOR-SETUP.md) for VS Code, Neovim, Helix, Cursor, JetBrains, and Zed status.
...
**Features**: Additional rule categories
