...
<p align="center">Catch broken agent configs before your AI tools silently ignore them.<br>212 rules across Claude Code, Codex CLI, OpenCode, Cursor, Copilot, and more -<br>validating CLAUDE.md, SKILL.md, hooks, MCP configs, and other agent files.</p>
...
agnix validates all of it - 212 rules sourced from official specs, academic research, and real-world breakage patterns. Auto-fix included.
...
[Full CLI reference](https://avifenesh.github.io/agnix/docs/configuration) | [All 212 rules](https://avifenesh.github.io/agnix/docs/rules)
