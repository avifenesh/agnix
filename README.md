...
**129 validation rules** | **Auto-fix** | **[VS Code](https://marketplace.visualstudio.com/items?itemName=avifenesh.agnix) + [JetBrains](https://plugins.jetbrains.com/plugin/30087-agnix) + Neovim + Zed** | **GitHub Action**
...
agnix validates configs against 129 rules derived from official specs, research papers, and real-world testing. Catch issues before they reach your IDE.
...
- `get_rules` - List all 129 validation rules
...
agnix validates against 129 rules, but the agent config ecosystem moves fast.
