...
> 211 validation rules across 30 categories, sourced from 75+ references
...
|---------------|------------|
| **Implement validator** | [VALIDATION-RULES.md](./VALIDATION-RULES.md) - 211 rules with detection logic |
...
├── VALIDATION-RULES.md             # ⭐ Master validation reference (211 rules)
