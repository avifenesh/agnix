...
|---------------|------------|
| **Implement validator** | [VALIDATION-RULES.md](./VALIDATION-RULES.md) - 200 rules with detection logic |
...
├── VALIDATION-RULES.md             # ⭐ Master validation reference (200 rules)
...
| **Total** | **75+** | **117KB** | **160KB** | **200 rules** |
...
**Start here**: [VALIDATION-RULES.md](./VALIDATION-RULES.md) - 200 rules with rule IDs (AS-001, CC-HK-001, etc.)
