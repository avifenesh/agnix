...
**127 rules** | **Real-time diagnostics** | **Auto-fix** | **Completion** | **Multi-tool support**
...
- **Validates 127 rules** - From official specs and best practices
...
| `agnix: Show All Rules` | - | Browse 127 rules by category |
