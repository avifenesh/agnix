...
**220 rules** | **Real-time diagnostics** | **Auto-fix** | **Completion** | **Multi-tool support**
...
- **Validates 220 rules** - From official specs and best practices
...
| `agnix: Show All Rules` | - | Browse 220 rules by category |
