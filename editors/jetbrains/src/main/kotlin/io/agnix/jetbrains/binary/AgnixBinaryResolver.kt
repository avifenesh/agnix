...
class AgnixBinaryResolver {
    ...
    // Instance methods delegate to companion object for backwards compatibility
    fun getStorageDirectory() = Companion.getStorageDirectory()
    fun getDownloadedBinaryPath() = Companion.getDownloadedBinaryPath()
    fun findInPath() = Companion.findInPath()
    fun findInCommonLocations() = Companion.findInCommonLocations()
    fun resolve() = Companion.resolve()
    fun isValidBinary(path: String) = Companion.isValidBinary(path)
}
